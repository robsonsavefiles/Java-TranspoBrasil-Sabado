          ...
          <tr>
              <td>
                  <form method="post" action="productos.jsp">
                      <input type="submit" class="btn btn-warning" value="Regresar"/>
                  </form>
              </td>
          </tr>
        <tr>
            <td>
                ...
                String sql="select IdProducto,Descripcion,Marca,Precio,Stock,nombre,imagen from productos p, categoria c where  p.idcategoria=c.codigo and p.idcategoria='"+cat+"' order by 1 asc";
