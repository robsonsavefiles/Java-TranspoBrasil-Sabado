          ...
          <tr>
            <td><!-- InstanceBeginEditable name="EditRegion1" -->
              <table width="100%" border="0">
                <tr>
                    <td><h1><p class="text-center"><marquee  scrolldelay="1" scrollamount="2" direction="left" loop="infinite" onmouseout="this.start()" onmouseover="this.stop()">Bienvenido a la Zona de Mantenimiento</marquee></p></h1></td></td>
                </tr>
                  <tr>
                      <td align="center"><img src="../recursos/mantenimiento.jpg" width="500" height="350" /></td>
