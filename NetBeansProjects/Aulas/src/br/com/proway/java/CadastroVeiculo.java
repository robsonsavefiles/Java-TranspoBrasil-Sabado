...
public class CadastroVeiculo {
    ...
    private void editar() {
        ...
        if (veiculo != null) {
            ...
            //System.out.println("Data de alteraçao"+veiculo.getDataAlteracao());
    ...
    private void listFabAte() {
        ...
        RepositorioVeiculo repositorio = new RepositorioVeiculo();
        ArrayList<Veiculo> anoFabricacaoAte = repositorio.BuscarPorAnoFabricacaoAte(teclado.nextInt());
    ...
    private void listFabModate() {
        ...
        RepositorioVeiculo repositorio = new RepositorioVeiculo();
        ArrayList<Veiculo> anoModeloAte = repositorio.BuscarPorAnoModeloAte(teclado.nextInt());
