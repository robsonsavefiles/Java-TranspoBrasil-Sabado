...
public class PedidoTest {
    ...
    public static void main(String[] args) {
        ...
        pedido.addItem(feijao, 1);
        pedido.addItem(cocacola, 1);

        System.out.println(pedido);
        // pedidoItem.setQuantidade(100);

        feijao.setPreco(50000);
        System.out.println(pedido);
        
        for (int index = 0; index < pedido.getQuantidadeItens();index++) {
            System.out.printf("%s - %.2f\r\n",pedido.getNomeProduto(index),pedido.getPrecoProduto(index));
