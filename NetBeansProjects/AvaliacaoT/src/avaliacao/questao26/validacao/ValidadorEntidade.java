...
public abstract class ValidadorEntidade extends Validador {
    ...
    public final static String DEFAULT_DESC_ERR_EXISTS = "não existe.";
    ...
    public List<Erro> validarDataCriacao(Object conteudo) {
        ...
        try {
            ...
            if (data.after(new Date())) {
                addErroNaLista(new Erro(EntidadeInfo.CAMPO_DATA_CRIACAO, "não pode ser futuro."), erros);
            }
    ...
    public List<Erro> validarDataAlteracao(Object conteudo) {
        ...
        try {
            ...
            if (data.after(new Date())) {
                addErroNaLista(new Erro(EntidadeInfo.CAMPO_DATA_ALTERACAO, "não pode ser futuro."), erros);
            }
