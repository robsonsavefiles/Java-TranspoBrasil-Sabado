...
public abstract class ProdutoInfo extends EntidadeInfo {
    ...
    public static final InfoCampo CAMPO_CODIGO = new InfoCampo("C�digo do " + NOME_SINGULAR, 20);
    public static final InfoCampo CAMPO_NOME = new InfoCampo("Nome " + NOME_SINGULAR, 50);
    public static final InfoCampo CAMPO_DESCRICAO = new InfoCampo("Descri��o " + NOME_SINGULAR, 50);
