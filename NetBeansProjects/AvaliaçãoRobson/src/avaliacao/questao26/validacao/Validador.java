...
public abstract class Validador {
    ...
    public final static String DEFAULT_DESC_ERR_TYPE_NUMBER = "deve ser um número.";
    public final static String DEFAULT_DESC_ERR_NUMBER_STRING = "deve conter apenas números.";
    public final static String DEFAULT_DESC_ERR_VALUE_STRING = "deve conter apenas números e/ou \".\".";
    ...
    public Erro validarTamanhoString(InfoCampo campo, String conteudo, int tamanhoMin, int tamanhoMax) {
        if (conteudo.length() < tamanhoMin) {
            return new Erro(campo, "deve ter no mínimo " + tamanhoMin + " caracteres.");
        }
        if (conteudo.length() > tamanhoMax) {
            return new Erro(campo, "deve ter no máximo " + tamanhoMax + " caracteres.");
        }
        return null;
    }
