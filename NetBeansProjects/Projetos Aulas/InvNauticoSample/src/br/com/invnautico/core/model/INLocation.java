 ...
 */
public class INLocation implements Serializable, INBasicEntity, Comparable {
  ...
  public INLocation(Integer id, String descricao, boolean ativo) {
    this.id = id;
