...
import executor.Utilitariologin;
...
public class Tela extends javax.swing.JFrame {
    ...
    private void btnAcessarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAcessarActionPerformed
        try {
             if (lblLogin.getText().equals("gerente") && (lblSenha.getText().equals("gerente123"))) {
        ...
        } else if (lblLogin.getText().equals("medico") && (lblSenha.getText().equals("medico123"))) {
            JOptionPane.showMessageDialog(null, "ACESSO PERMITIDO:");
            usuario = "medico";
            new Menu().setVisible(true);
        ...
        } else if (lblLogin.getText().equals("atendente") && (lblSenha.getText().equals("atendente123"))) {
            JOptionPane.showMessageDialog(null, "ACESSO PERMITIDO:");
            usuario = "atendente";
            new Menu().setVisible(true);
//            new Visitante().setVisible(true);
            ...
            if(Utilitariologin.login(lblLogin.getText(),lblSenha.getText())){
