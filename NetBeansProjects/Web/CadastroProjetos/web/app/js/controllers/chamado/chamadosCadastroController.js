angular.module("projeto")
        .controller("chamadosCadastroController", ["$rootScope", "$scope", "ChamadosService", "ProjetosService", "$state", "$stateParams",
            function ($rootScope, $scope, ChamadosService, ProjetosService, $state, $stateParams) {
                var self = this;
